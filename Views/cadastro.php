...
<html>
    ...
    <body class="body">
		...
		<div>
        	<form name="form1" id="form1" method="POST" action="/liblab/register" onsubmit="return validaCad()">
    			<h1>Cadastro</h1>
				<label class="cad" for = "Nome completo">Nome de Usuário:</label>
    			<input type="text" name="nome" maxlength="150" size="40" minlength="5" placeholder="Nome completo" id="nomeCompleto" autocomplete="off">
    			...
    			<input type="password" name="senha" minlength="5" maxlength="100" size="25" placeholder="Senha" id="pwd" onclick="">
				...
				<a href="/liblab/login"></a>Já tem conta? Entrar</a><br>
			</form>
    	</div>
    </body>
</html>